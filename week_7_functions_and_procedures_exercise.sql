-- WEEK 7 FUNCTIONS AND PROCEDURE EXERCISE
...
DELIMITER $$
CREATE PROCEDURE top10ProductsIn2004()
BEGIN
SELECT p.productCode, p.productName, p.productLine, p.productVendor, 
       p.buyPrice, p.MSRP, AVG(od.priceEach) as avgPriceEach, SUM(od.quantityOrdered) as totalQuantityOrdered, 
